...
- [Clash](https://github.com/lijinglin3/clash): 发布于[github.com/lijinglin3/clash](https://github.com/lijinglin3/clash)的开源版本
- [Clash Premium 版本](https://github.com/lijinglin3/clash/releases/tag/premium): 具有[TUN 和更多支持](/zh_CN/premium/introduction) 的专有内核 (免费)
...
Clash 是根据 [GPL-3.0](https://github.com/lijinglin3/clash/blob/main/LICENSE) 开源许可证发布的.

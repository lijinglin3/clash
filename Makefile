...
GOBUILD=CGO_ENABLED=0 go build -trimpath -ldflags '-X "github.com/lijinglin3/clash/constant.Version=$(VERSION)" \
		-X "github.com/lijinglin3/clash/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
